package com.chimanos.spacequiz.quiz.util;
...
import static com.chimanos.spacequiz.quiz.model.Constants.START_QUIZ_MESSAGE;
import static com.chimanos.spacequiz.quiz.model.Constants.STATES;
...
public class QuestionUtils {
    ...
    public static String getQuestionText(int counter, StateProperty stateProperty, State state) {
        if(counter == 1) {
            return "Voici votre " + counter + "ére question.  Qu'elle est la/le " + stateProperty.getValue() + " de "  + state.getName() + "?";
        } else {
            return "Voici votre " + counter + "éme question.  Qu'elle est la/le " + stateProperty.getValue() + " de "  + state.getName() + "?";
        }
    }
